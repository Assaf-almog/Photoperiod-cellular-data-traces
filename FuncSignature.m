function [ sigma, Q, M] = FuncSignature(TS, nullModel, cdAlg )
%% FuncSignature
...
%
%% Example:
% [communities, Q, Modu]=FuncSignature(myData,3,1)
%
%% Disclaimer
...
function M = FinRMT(TS, nullModel)
%% FinRMT
...
C = corr(diffs);    % Create a correlation matrix and ensure
